...
restartButton.addEventListener("click", () => {
  socket.emit("restartGame"); //  reiniciar el juego
});

// Escuchar el evento 'restartGame' 
socket.on("restartGame", () => {
  // Volver a la pantalla de resultados con puntuaciones en 0
  gameOverScreen.style.display = "none";
  homeScreen.style.display = "flex"; // redirigir a otra pantalla 
});
